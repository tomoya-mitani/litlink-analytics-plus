# lit.link Analytics Period Aggregator
...
2. **スクリプトをインストール**：
   - [lit-link-analytics.user.js](https://github.com/YOUR_USERNAME/lit-link-analytics-userscript/raw/main/lit-link-analytics.user.js) をクリック
